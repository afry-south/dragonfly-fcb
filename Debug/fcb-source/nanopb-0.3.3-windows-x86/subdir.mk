...
../fcb-source/nanopb-0.3.3-windows-x86/pb_encode.c 

OBJS += \
./fcb-source/nanopb-0.3.3-windows-x86/pb_common.o \
./fcb-source/nanopb-0.3.3-windows-x86/pb_decode.o \
./fcb-source/nanopb-0.3.3-windows-x86/pb_encode.o 

C_DEPS += \
./fcb-source/nanopb-0.3.3-windows-x86/pb_common.d \
./fcb-source/nanopb-0.3.3-windows-x86/pb_decode.d \
./fcb-source/nanopb-0.3.3-windows-x86/pb_encode.d 


# Each subdirectory must supply rules for building sources it contributes
fcb-source/nanopb-0.3.3-windows-x86/%.o: ../fcb-source/nanopb-0.3.3-windows-x86/%.c
	@echo 'Building file: $<'

...
\chapter{State Estimation Theory}
	...
	\section{Attitude Estimation}
		\subsection{Accelerometer \& Gyroscope Fusion: Kalman Filter}
		...
		angle += dt*newRate - dt*bias;
		//newRate is the rate from the gyroscope
		\end{lstlisting}
		...
		\begin{lstlisting}[frame=single]
		y = newAngle - angle; 
		//newAngle is the angle from the accelerometer
		\end{lstlisting}

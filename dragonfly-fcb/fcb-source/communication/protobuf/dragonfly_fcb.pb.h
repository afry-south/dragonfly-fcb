...
typedef struct _ControlReferenceSignalsProto {
    ...
    bool has_refYawRate;
    float refYawRate;
/* @@protoc_insertion_point(struct:ControlReferenceSignalsProto) */
...
typedef struct _FlightStatesProto {
    ...
    bool has_yawRate;
    float yawRate;
/* @@protoc_insertion_point(struct:FlightStatesProto) */
} FlightStatesProto;
...
typedef struct _MotorSignalValuesProto {
    ...
    bool has_M4;
    int32_t M4;
/* @@protoc_insertion_point(struct:MotorSignalValuesProto) */
...
typedef struct _PIDControlParamsProto {
    ...
    bool has_Td_yawrate;
    float Td_yawrate;
/* @@protoc_insertion_point(struct:PIDControlParamsProto) */
...
typedef struct _ReceiverSignalValuesProto {
    ...
    bool has_aux1;
    int32_t aux1;
/* @@protoc_insertion_point(struct:ReceiverSignalValuesProto) */
...
typedef struct _SensorSamplesProto {
    ...
    bool has_magZ;
    float magZ;
/* @@protoc_insertion_point(struct:SensorSamplesProto) */
} SensorSamplesProto;
...
typedef struct _SimulatedStatesProto {
    ...
    bool has_rateYaw;
    float rateYaw;
/* @@protoc_insertion_point(struct:SimulatedStatesProto) */
} SimulatedStatesProto;

/* Default values for struct fields */

/* Initializer values for message structs */
#define ReceiverSignalValuesProto_init_default   {false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0}
...
#define ReceiverSignalValuesProto_init_zero      {false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0}
...
#define FlightStatesProto_rollAngle_tag          7
#define FlightStatesProto_pitchAngle_tag         8
#define FlightStatesProto_yawAngle_tag           9
#define FlightStatesProto_rollRate_tag           10
#define FlightStatesProto_pitchRate_tag          11
#define FlightStatesProto_yawRate_tag            12
...
#define ReceiverSignalValuesProto_is_active_tag  1
#define ReceiverSignalValuesProto_throttle_tag   2
#define ReceiverSignalValuesProto_aileron_tag    3
#define ReceiverSignalValuesProto_elevator_tag   4
#define ReceiverSignalValuesProto_rudder_tag     5
#define ReceiverSignalValuesProto_gear_tag       6
#define ReceiverSignalValuesProto_aux1_tag       7
...
extern const pb_field_t ReceiverSignalValuesProto_fields[8];
...
#define ReceiverSignalValuesProto_size           68

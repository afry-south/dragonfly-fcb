...
static void USB_ComPort_RX_Thread(void const *argument)
{
  ...
  static uint8_t rxTempBuffer[MAX_CLI_COMMAND_SIZE]; // TODO move this to CLIHandleData
  static uint8_t tempOutBuffer[MAX_CLI_OUTPUT_SIZE]; // TODO move this to CLIHandleData
          ...
          if(getByte == '\n')
            {
              do
                {
                  // TODO: Make CLIHandleDataFunction in usb_cdc_cli.c/.h

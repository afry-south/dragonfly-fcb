...
In this example, 1 EXTI line (EXTI0) when using the STM32F3-Discovery is configured 
...
- when rising edge is detected on EXTI0 by pressing User button, LED3, LED6, LED7
  and LED10 toggle.

@par Directory contents 

  - EXTI_Example/stm32f30x_conf.h     Library Configuration file
  - EXTI_Example/stm32f30x_it.c       Interrupt handlers
  - EXTI_Example/stm32f30x_it.h       Header for stm32f30x_it.c

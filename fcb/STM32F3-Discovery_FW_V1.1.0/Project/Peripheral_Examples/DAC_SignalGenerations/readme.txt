/**
  @page DAC_SignalsGenerations DAC Signals generation example
  
  @verbatim
  ******************** (C) COPYRIGHT 2012 STMicroelectronics *******************
  * @file    DAC_SignalsGenerations/readme.txt 
...
waveforms to DAC.
For each press on User button, 2 signals are selected and monitored on the 
two DAC channels:
...
@par Directory contents 
  ...
  - DAC_SignalsGenerations/stm32f30x_conf.h     Library Configuration file
  - DAC_SignalsGenerations/stm32f30x_it.c       Interrupt handlers
  - DAC_SignalsGenerations/stm32f30x_it.h       Header for stm32f30x_it.c
  - DAC_SignalsGenerations/main.c               Main program
  - DAC_SignalsGenerations/main.h               Header for main.c
  - DAC_SignalsGenerations/system_stm32f30x.c   STM32F30x system source file
...
@par Hardware and Software environment
  ...
  - STM32F3-Discovery Set-up
    -  Connect PA.04 (DAC Channel1) and PA.05 (DAC Channel2) pins to an 
       oscilloscope.
...
In order to make the program work, you must do the following :
 ...
 + EWARM
    - Open the DAC_SignalsGenerations.eww workspace 
    - Rebuild all files: Project->Rebuild all
    - Load project image: Project->Debug
    - Run program: Debug->Go(F5)

 + MDK-ARM
    - Open the DAC_SignalsGenerations.uvproj project
 ...
 + TASKING
    ...
    - Click on File->Import, select General->'Existing Projects into Workspace' 
      and then click "Next". 
    - Browse to  TASKING workspace directory and select the project "DAC_SignalsGenerations"   
 ...
 + TrueSTUDIO for ARM
    ...
    - Click on File->Import, select General->'Existing Projects into Workspace' 
      and then click "Next". 
    - Browse to the TrueSTUDIO workspace directory and select the project "DAC_SignalsGenerations" 
    - Rebuild all project files: Select the project in the "Project explorer" 
      window then click on Project->build project menu.
    - Run program: Select the project in the "Project explorer" window then click 
      Run->Debug (F11)

...
This example creates a periodic timer that calls a callback function every 200 ms to toggle the LED2.
...
@par Directory contents
    ...
    - FreeRTOS/FreeRTOS_Timers/Src/stm32f3xx_it.c        Interrupt handlers
    - FreeRTOS/FreeRTOS_Timers/Src/system_stm32f3xx.c    STM32F3xx system clock configuration file
    - FreeRTOS/FreeRTOS_Timers/Inc/main.h                Main program header file
    - FreeRTOS/FreeRTOS_Timers/Inc/stm32f3xx_hal_conf.h  HAL Library Configuration file
    - FreeRTOS/FreeRTOS_Timers/Inc/stm32f3xx_it.h        Interrupt handlers header file

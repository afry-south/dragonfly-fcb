...
@par Hardware and Software environment
  ...
  - This example has been tested with a STM32F334R8-Nucleo Rev C board embedding
    a STM32F334R8T6 device and can be easily tailored to any other supported device 

...
void HAL_PCD_MspInit(PCD_HandleTypeDef *hpcd)
{
  ...
  /* Enable the clock of DM pin*/
  __GPIOA_CLK_ENABLE();

  /* Enable the clock of DP pin*/
  __GPIOA_CLK_ENABLE();
  ...
  /* Configure USB DP pin. This is optional, and maintained only for user guidance. */
...
static void SystemClockConfig_STOP(void)
{
  ...
  /* Change Systick priority: should be higher than User push-button interrupt */
